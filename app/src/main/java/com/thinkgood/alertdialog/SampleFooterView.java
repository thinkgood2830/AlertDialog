...
import com.thinkgood.customalertdialog.CFPushButton;
...
public class SampleFooterView extends LinearLayout implements View.OnClickListener {
    ...
    private void showHeader() {
        headerToggleButton.setTag(HeaderState.SHOWN);
    ...
    private void hideHeader() {
        headerToggleButton.setTag(HeaderState.HIDDEN);
    ...
    void collapseConfiguration() {
        configurationToggleButton.setTag(ConfigurationState.COLLAPSED);
    ...
    void expandConfiguration() {
        configurationToggleButton.setTag(ConfigurationState.EXPANDED);
